...
r = requests.get('https://emojipedia.org/messenger/')
...
with open('src/data/messenger_emojis', 'w+') as file:
    file.write(str(messenger_emojis))

with open('node_modules/emojilib/emojis.json') as file:
...
with open('src/data/supported_emojis', 'w+') as file:
